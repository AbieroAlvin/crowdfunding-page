  ...
  return (
    <div className="flex flex-col items-center px-8 rounded-xl shadow-xl w-[90%] relative py-6 bg-white gap-6 mx-auto">
      <div className=" flex flex-col gap-3">
        ...
        <div className="space-y-4 text-[var(--Dark-gray)] leading-7">
          <p>
          ...
          <div key={pledge.id}>
            ...
            >
              <div className="md:flex md:items-center md:justify-between">
                ...
                <p className="py-1.5 font-medium text-[var(--Moderate-cyan)] lg:py-1 lg:text-[0.95rem]">
              ...
              <div className="md:flex md:justify-between md:pt-1">
                ...
                <div className="py-[1.1rem] lg:py-1.5">
                  {pledge.left === true ? (
                    <TriggerModalButton
                      text="Select Reward"
                      className="bg-[var(--Moderate-cyan)] px-[1.8rem] py-3.5 hover:bg-[var(--Dark-cyan)] lg:py-3"
                    />
                  ) : (
                    <TriggerModalButton
                      text="Out of Stock"
                      disabled={true}
                      className="mt-0.5 bg-[var(--Dark-gray)] px-[2.1rem] py-3.5 lg:mt-0 lg:py-3"
                    />
                  )}
                </div>
              </div>
